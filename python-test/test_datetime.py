...
class TestDatetime:
    def test_datetime_naive(self):
        ...
        """
        assert (
            pyyjson.dumps([datetime.datetime(2000, 1, 1, 2, 3, 4, 123)])
    ...
    def test_datetime_pytz_utc(self):
        ...
        """
        assert (
            pyyjson.dumps([datetime.datetime(2018, 6, 1, 2, 3, 4, 0, tzinfo=pytz.UTC)])
            == b'["2018-06-01T02:03:04+00:00"]'
        )
    ...
    def test_datetime_microsecond_max(self):
        ...
        """
        assert (
            pyyjson.dumps(datetime.datetime(2000, 1, 1, 0, 0, 0, 999999))
    ...
    def test_datetime_microsecond_min(self):
        ...
        """
        assert (
            pyyjson.dumps(datetime.datetime(2000, 1, 1, 0, 0, 0, 1))
    ...
    def test_datetime_omit_microseconds(self):
        ...
        assert (
            pyyjson.dumps(
                [datetime.datetime(2000, 1, 1, 2, 3, 4, 123)],
                option=pyyjson.OPT_OMIT_MICROSECONDS,
            )
    ...
    def test_datetime_omit_microseconds_naive(self):
        ...
        assert (
            pyyjson.dumps(
                [datetime.datetime(2000, 1, 1, 2, 3, 4, 123)],
                option=pyyjson.OPT_NAIVE_UTC | pyyjson.OPT_OMIT_MICROSECONDS,
            )
    ...
    def test_time_omit_microseconds(self):
        ...
        assert (
            pyyjson.dumps(
                [datetime.time(2, 3, 4, 123)], option=pyyjson.OPT_OMIT_MICROSECONDS
            )
            == b'["02:03:04"]'
        )
    ...
    def test_datetime_utc_z_naive(self):
        ...
        assert (
            pyyjson.dumps(
                [datetime.datetime(2000, 1, 1, 2, 3, 4, 123)],
                option=pyyjson.OPT_NAIVE_UTC | pyyjson.OPT_UTC_Z,
            )
    ...
    def test_datetime_utc_z_without_tz(self):
        ...
        assert (
            pyyjson.dumps(
                [datetime.datetime(2000, 1, 1, 2, 3, 4, 123)], option=pyyjson.OPT_UTC_Z
            )
            == b'["2000-01-01T02:03:04.000123"]'
        )
    ...
    def test_datetime_roundtrip(self):
        ...
        serialized = pyyjson.dumps(obj).decode("utf-8").replace('"', "")
...
class TestDate:
    def test_date(self):
        ...
        datetime.date
        """
        assert pyyjson.dumps([datetime.date(2000, 1, 13)]) == b'["2000-01-13"]'
    ...
    def test_date_min(self):
        ...
        """
        assert (
            pyyjson.dumps([datetime.date(datetime.MINYEAR, 1, 1)]) == b'["0001-01-01"]'
        )
    ...
    def test_date_max(self):
        ...
        """
        assert (
            pyyjson.dumps([datetime.date(datetime.MAXYEAR, 12, 31)]) == b'["9999-12-31"]'
        )
...
class TestTime:
    def test_time(self):
        ...
        datetime.time
        """
        assert pyyjson.dumps([datetime.time(12, 15, 59, 111)]) == b'["12:15:59.000111"]'
        assert pyyjson.dumps([datetime.time(12, 15, 59)]) == b'["12:15:59"]'
    ...
    def test_time_microsecond_max(self):
        ...
        """
        assert pyyjson.dumps(datetime.time(0, 0, 0, 999999)) == b'"00:00:00.999999"'

    def test_time_microsecond_min(self):
        """
        datetime.time microsecond min
        """
        assert pyyjson.dumps(datetime.time(0, 0, 0, 1)) == b'"00:00:00.000001"'
...
class TestDateclassPassthrough:
    def test_passthrough_datetime(self):
        with pytest.raises(pyyjson.JSONEncodeError):
            pyyjson.dumps(
                datetime.datetime(1970, 1, 1), option=pyyjson.OPT_PASSTHROUGH_DATETIME
            )

    def test_passthrough_date(self):
        with pytest.raises(pyyjson.JSONEncodeError):
            pyyjson.dumps(
                datetime.date(1970, 1, 1), option=pyyjson.OPT_PASSTHROUGH_DATETIME
            )

    def test_passthrough_time(self):
        with pytest.raises(pyyjson.JSONEncodeError):
            pyyjson.dumps(
                datetime.time(12, 0, 0), option=pyyjson.OPT_PASSTHROUGH_DATETIME
            )
    ...
    def test_passthrough_datetime_default(self):
        ...
        assert (
            pyyjson.dumps(
                ...
                option=pyyjson.OPT_PASSTHROUGH_DATETIME,
                default=default,
            )
